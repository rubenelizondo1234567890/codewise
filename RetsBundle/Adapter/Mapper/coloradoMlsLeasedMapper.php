...
use RetsBundle\Adapter\mlsLeasedMapper;
 ...
 */
class coloradoMlsLeasedMapper extends mlsLeasedMapper
{
    /* @var marketId */
    protected $marketId;
    ...
    function setMappedProperties($key, $value)
    {
        ...
        $this->setDateAlvCalculated(MlsNormalizer::normalizeType('now', 'DateTime'));
