...
class errorMsg extends model
{
     ...
     * @return string
     */
    public function geterrorCode($eCode)
    {
    	switch ($eCode) {
    		case 'e1':
    			return '<span style="color:red">E0001</span>';
    			break;
    		case 'e2':
    			return '<span style="color:red">E0002</span>';
    			break;
    		case 'e3':
    			return '<span style="color:red">E0003</span>';
    			break;
    		case 'e4':
    			return '<span style="color:red">E0004</span>';
    			break;
    		case 'e5':
    			return '<span style="color:red">E0005</span>';
    			break;
    		
    		default:
    			return '<span style="color:red">unknown ErrorCode</span>';
    			break;
    	}
    }
     ...
     * @return string
     */
    public function geterrorText($eCode, $msg = '')
    {
    	switch ($eCode) {
    		case 'e1':
    			return 'Error setting data. please review and try again';
    			break;
